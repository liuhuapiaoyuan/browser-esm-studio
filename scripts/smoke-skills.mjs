...
assert.match(questPrompt, /quest-blueprint\.ts/);
...
assert.match(panoramaPrompt, /panorama-blueprint\.ts/);
...
assert.match(slidesPrompt, /slides-blueprint\.ts/);
...
assert.match(lessonGamePrompt, /lesson-game-blueprint\.ts/);
...
assert.match(usagePrompt, /usage-tracking\.ts/);
